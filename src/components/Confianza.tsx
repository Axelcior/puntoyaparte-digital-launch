...
<section id="por-que-escogernos" className="section-dark py-20 md:py-28">
    <div className="container-section">
      ...
      <div className="max-w-3xl mx-auto text-center mb-20">
        <span className="font-semibold uppercase tracking-widest text-gold mb-4 block text-xl">Nuestra misión</span>
        <p className="text-lg md:text-xl text-foreground/70 leading-relaxed text-justify">
